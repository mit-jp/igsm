...
!
! This is needed because some implementations of CLMMPI with MPMD so that
...
!   of common CLMMPI implementations.  For example, SGI's clmmpirun syntax is not 
...
!   ie. clmmpirun can't handle this:
