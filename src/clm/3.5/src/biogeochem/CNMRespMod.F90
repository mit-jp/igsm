...
!CAS ***************** Sensitive ********************************
!CAS
!CAS  NOTE 1: Modify according to TEM rxTLaRS in tveg45.cpp
!CAS  NOTE 2: Need to be mindful of TEMVEG and IGSMVEG distinctions
!CAS  NOTE 3: Modify 'br' according PFT
!CAS
