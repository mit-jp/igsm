...
!CAS ******************** SENSITIVE *********************************
!CAS
!CAS: CAN REPLACE THE WATER RATE SCALAR (W_SCALAR) WITH DIFFERENT ALGORITHM USED
!CAS     BY TEM (found in setRHMOIST of tmcrb45.cpp
!CAS
...
!CAS
!CAS:  NOTE: CHECK TEM'S 'nminxclm' CODE TO DETERMINE DIFFERENCES (IF ANY)
!CAS
