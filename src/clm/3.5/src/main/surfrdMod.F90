...
!-----------------------------------------------------------------------
    ...
    call clmmpi_bcast (ni, 1, CLMMPI_INTEGER, 0, clmmpicom, ier)
    call clmmpi_bcast (nj, 1, CLMMPI_INTEGER, 0, clmmpicom, ier)
...
!tcx fix, see also lat_o_local in areaMod.F90
    ...
    call clmmpi_bcast (domain%latn , size(domain%latn) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (domain%lats , size(domain%lats) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (domain%lonw , size(domain%lonw) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (domain%lone , size(domain%lone) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (domain%area , size(domain%area) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (domain%latc , size(domain%latc) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (domain%lonc , size(domain%lonc) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (domain%pftm , size(domain%pftm) , CLMMPI_INTEGER, 0, clmmpicom, ier)
    call clmmpi_bcast (domain%edges, size(domain%edges), CLMMPI_REAL8  , 0, clmmpicom, ier)
...
!tcx fix, see also lat_o_local in areaMod.F90
    ...
    call clmmpi_bcast (latlon%latc , size(latlon%latc) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (latlon%lonc , size(latlon%lonc) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (latlon%lats , size(latlon%lats) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (latlon%latn , size(latlon%latn) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (latlon%lonw , size(latlon%lonw) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (latlon%lone , size(latlon%lone) , CLMMPI_REAL8  , 0, clmmpicom, ier)
    call clmmpi_bcast (latlon%edges, size(latlon%edges), CLMMPI_REAL8  , 0, clmmpicom, ier)
    if (present(mask)) then
       call clmmpi_bcast(mask       , size(mask)         , CLMMPI_INTEGER, 0, clmmpicom, ier)
    endif
...
!-----------------------------------------------------------------------
    ...
    call clmmpi_bcast (domain%mask , size(domain%mask) , CLMMPI_INTEGER, 0, clmmpicom, ier)
    call clmmpi_bcast (domain%frac , size(domain%frac) , CLMMPI_REAL8  , 0, clmmpicom, ier)
