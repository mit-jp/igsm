...
!
!CAS:	Re-invoked the ONE_RESTART file option
!
          !restFile_filename = "./"//trim(caseid)//".clm2.r."//trim(cdate)
          restFile_filename = "./"//trim(caseid)//".clm2.rst"
...
!
             ...
             restFile_filename = "./"//trim(caseid)//".clm2.rst.nc"
...
! !USES:
    ...
    use spmdMod     , only : clmmpicom, CLMMPI_LOGICAL
