...
!-----------------------------------------------------------------------
    ...
    call clmmpi_bcast (z0mr, size(z0mr), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (displar, size(displar), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (dleaf, size(dleaf), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (c3psn, size(c3psn), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (vcmx25, size(vcmx25), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (mp, size(mp), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (qe25, size(qe25), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (rhol, size(rhol), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (rhos, size(rhos), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (taul, size(taul), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (taus, size(taus), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (xl, size(xl), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (roota_par, size(roota_par), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (rootb_par, size(rootb_par), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (crop, size(crop), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (smpso, size(smpso), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (smpsc, size(smpsc), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (fnitr, size(fnitr), CLMMPI_REAL8, 0, clmmpicom, ier)

    ! begin variables used only for CN code
    call clmmpi_bcast (slatop, size(slatop), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (dsladlai, size(dsladlai), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (leafcn, size(leafcn), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (flnr, size(flnr), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (woody, size(woody), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (lflitcn, size(lflitcn), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (frootcn, size(frootcn), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (livewdcn, size(livewdcn), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (deadwdcn, size(deadwdcn), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (froot_leaf, size(froot_leaf), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (stem_leaf, size(stem_leaf), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (croot_stem, size(croot_stem), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (flivewd, size(flivewd), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (fcur, size(fcur), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (lf_flab, size(lf_flab), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (lf_fcel, size(lf_fcel), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (lf_flig, size(lf_flig), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (fr_flab, size(fr_flab), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (fr_fcel, size(fr_fcel), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (fr_flig, size(fr_flig), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (dw_fcel, size(dw_fcel), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (dw_flig, size(dw_flig), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (leaf_long, size(leaf_long), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (evergreen, size(evergreen), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (stress_decid, size(stress_decid), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (season_decid, size(season_decid), CLMMPI_REAL8, 0, clmmpicom, ier)
    call clmmpi_bcast (resist, size(resist), CLMMPI_REAL8, 0, clmmpicom, ier)
    ! end variables used only for CN code
