...
! !USES:
  ...
  use spmdMod         , only : masterproc, clmmpicom
...
! !PUBLIC MEMBER FUNCTIONS:
  public :: csm_setup          ! Setup, clmmpi_init
  public :: csm_shutdown       ! Shutdown, clmmpi_finalize
...
!
! !INTERFACE:
  subroutine csm_setup(clmmpicom)
!
! !DESCRIPTION:
...
! !ARGUMENTS:
    implicit none
    integer, intent(out) :: clmmpicom  !MPI group communicator
!
! !REVISION HISTORY:
...
!------------------------------------------------------------------------
   ...
   call cpl_interface_init(cpl_fields_lndname,clmmpicom)
