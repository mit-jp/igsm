...
! to send an AttrVect between a component on M CLMMPI-processes and a component
! on N CLMMPI-processes.   This module defines the Router datatype and provides
...
!\begin{verbatim}
    ...
    type Router
      ...
      integer,dimension(:),pointer   :: ireqs,rreqs  ! buffer for CLMMPI_Requests
      integer,dimension(:,:),pointer :: istatus,rstatus  ! buffer for CLMMPI_Status
    end type Router
