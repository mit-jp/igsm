...
!BOP -------------------------------------------------------------------
!
! !MODULE: m_AccumulatorComms - CLMMPI Communication Methods for the Accumulator
!          
!
! !DESCRIPTION:
!
...
! are implemented in terms of the Message Passing Interface (CLMMPI) standard, 
! and we have as best as possible, made the interfaces to these routines 
! appear as similar as possible to the corresponding CLMMPI routines.  For the 
...
!           comms routine to match the CLMMPI model for collective
...
!           model to match CLMMPI comms model, and cleaned up prologue
...
!                 CLMMPI-like comms model, and cleaned up prologue.
!       09Aug01 - E.T. Ong <eong@mcs.anl.gov> - 2nd prototype. Used the  
...
!EOP ___________________________________________________________________
  ...
  call CLMMPI_BCAST(AccBuffSize, 1, MP_INTEGER, root, comm, ier)
  ...
  call CLMMPI_BCAST(AccBuff, AccBuffSize, MP_INTEGER, root, comm, ier)
