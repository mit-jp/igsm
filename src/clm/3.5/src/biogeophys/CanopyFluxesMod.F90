...
!cdir nodep
   ...
   if (found) then
      write(6,*)'Error: Forcing height is below canopy height for pft index ',index, ' grid ',g
      write(6,*)'displa',displa(p)
      write(6,*)'forc_hgt_u',forc_hgt_u(g)
      call endrun()
   end if
...
!CAS
!CAS:   NOTE: COULD ADD NITROGEN FUNCTION BELOW TO DOWNREGULATE GPP
!CAS
