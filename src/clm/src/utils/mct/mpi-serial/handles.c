...
void clmmpi_destroy_handles(void)
{
  int i;
...
void clmmpi_alloc_handle(int *handle, void **data)
{
  Handleitem *new;
  int i;
  ...
  blocks[nblocks]= (Handleitem *)clmmpi_malloc(sizeof(Handleitem)* BLOCK_ITEMS);
...
void *clmmpi_handle_to_ptr(int handle)
{
  int block;
  int index;
...
void clmmpi_free_handle(int handle)
{
  int block;
  int index;
  Handleitem *item;
