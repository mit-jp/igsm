...
! !INTERFACE:
    ...
    module m_die
      ...
      public :: MP_die		! a special die() for CLMMPI errors
      public :: MP_perr		! perr for CLMMPI errors, from m_clmmpif90
      public :: MP_perr_die	! a special die() for CLMMPI errors
...
!	before	- Tom Clune
!		- Created for CLMMPI PSAS implementation as a separate
!		  module
