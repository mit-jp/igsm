...
!------------------------------------------------------------------------
    ...
    do j = 1, datlat
       if ( j /= 8 .and. j /= 9 .and. j/= 45 .and. j /= 46 ) then
        j1 = j1 + 1
        do i = 1, datlon
            n = (j1-1)*datlon + i
            ...
            aV_atm_d2a%rAttr(izgcmxy,n) = 30.0
            aV_atm_d2a%rAttr(if_sols,n) = 0.7*swparmit(1,j)
            !write (6,*) 'ATMDRV: i = ',i,' j = ',j,' n = ',n
            !write (6,*) 'ATMDRV:  swparmit = ',swparmit(i,j)
            !write (6,*) 'ATMDRV:  aV_atm_swxy = ',aV_atm_d2a%rAttr(if_sols,n)
