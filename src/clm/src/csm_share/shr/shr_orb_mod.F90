...
!
! CAS
! CAS:  MODIFICATION OF ZENITH ANGLE CALCULATION FOR 3-D CLM IMPLEMENTATION TO
!       BE COUPLED WITH THE 2D ATMOSPHERE OF THE IGSM.
!       
!       FOR THE COMMUNICATION TO BE CONSISTENT, THE CLM LAT/LON GRIDS MUST 
!       HAVE A SYNCHRONOUS DIURNAL CYCLE AMONG ***ALL*** GRIDS,  THEREFORE
!       HAVE REMOVED THE 'LON' DEPENDENCY IN THE COSZ CALCULATION BELOW
!
