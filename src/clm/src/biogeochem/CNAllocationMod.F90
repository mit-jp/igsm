...
!CAS
!CAS:   COULD REPLACE THIS WITH COST-BENEFIT APPROACH OF TEM45-H
!CAS
...
!CAS ********************** IMPORTANT ************************************
!CAS NOTE: Can modify to constrain nitrogen uptake by other environmental
!CAS       and physiological factors as given by TEM
!CAS
...
!CAS ********************** IMPORTANT ************************************
!CAS
!CAS:  NOTE: WILL PASS A FILTERED (I.E. DAILY AVG?) VALUE OF '1-DOWNREG'
!CAS         TO MIMIC THE TEM-HYDRO APPROACH OF THE EFFECT OF N-LIMITATION ON
!CAS         HYDROLOGY VIA GPP AND Gc.
!CAS
