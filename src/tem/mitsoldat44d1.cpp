/* *************************************************************
MITSOLDAT44C.CPP - object to read and write the structure of 
...
20080130 - DWK changed include from mitsoldat437.h to
           mitsoldat44a.h
20080130 - DWK changed MITSoildata43:: to MITSoildata44::
20110707 - DWK changed include from mitsoldat44a.h to 
           mitsoldat44c.h
20150429 - DWK changed include from mitsoldat44c.h to
           mitsoldat44d1.h
...
MITSoildata44::MITSoildata44( void )
{
...
int MITSoildata44::get( ifstream& infile )
{
...
int MITSoildata44::getdel( FILE* infile )
{
  char tmpvarname[40];
  char tmpsource[40];
  char tmpregion[40];
...
void MITSoildata44::out( ofstream& ofile, 
                         const float& col, 
                         const float& row, 
...
void MITSoildata44::outdel( ofstream& ofile, 
                            const float& col, 
                            const float& row, 
                            const string& varname,
                            const long& carea, 
