/* *************************************************************
****************************************************************
IMITTEM44B.CXX - Interactive version of Terrestrial Ecosystem 
...
#include "regmittem44b.h"    // RegMITTEM Class
...
{  
  ...
  {
    // Open maximum cohort file for potential vegetation
    ...
    if( !ifnumchrts )
    {
      ...
      xtem.flog1 << " for POTVEG MXCOHRTS data input";
      xtem.flog1 << endl << endl;
