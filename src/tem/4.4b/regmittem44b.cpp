/* *************************************************************
REGMITTEM44B.CPP - Extrapolation version of the Terrestrial 
...
//      else { telmnt[igrd].year = mxcohrtdat.year; }
      ...
      for( ichrt = 0; ichrt < telmnt[igrd].maxcohorts; ++ichrt )
      {
        ...
        telmnt[igrd].cohort[ichrt].standage = lulcdat[ichrt].standage;
        ...
        telmnt[igrd].cohort[ichrt].disturbflag = lulcdat[ichrt].disturbflag;
        telmnt[igrd].cohort[ichrt].disturbmonth = lulcdat[ichrt].disturbmonth;
        telmnt[igrd].cohort[ichrt].FRI = lulcdat[ichrt].FRI;
        ...
        telmnt[igrd].region[ichrt] = lulcdat[ichrt].region;
