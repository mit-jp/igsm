/* *************************************************************
****************************************************************
IMITTEM44D1.CXX - Interactive version of Terrestrial Ecosystem 
...
20150428 - DWK added include "preproc.hpp to define STANDALONE_TEM
20150428 - DWK changed include from regmittem44c1.h to
           regmittem44d1.h
20150428 - DWK added xtem.setMITSoilCharacterRegion() to
           initTEM()
...
// NOTE: imittem44d1.cxx is the outer shell of the "offline" 
//       version of MITTEM.  Make sure the compiler directive 
//       STANDALONE_TEM in precproc.hpp is DEFINED below 
//       (preproc.hpp is also included in in regmittem44d1.h, 
//       regmittem44d1.cpp, climate4tem44d1.hpp, mitclm44d1.h 
//       and mitclm44d1.cpp
...
#include "regmittem44d1.h"    // RegMITTEM Class
  ...
  if( 0 == xtem.equil )
  {
    for( dyr = 1; dyr < xtem.RTIME; ++dyr )
    {
      ...
      for ( dm = 0; dm < CYCLE; ++dm )
      {
        ...
        if ( xtem.istateflag > 0 
             || (0 == xtem.istateflag && dyr > xtem.totsptime) ) 
        {  
                       ...
                       RegMITTEM& xtem )
{
  ...
  if ( 0 == pdm )
  {
    ...
    if( 0 == xtem.istateflag && pdyr < (xtem.totsptime+1) )
    {
...
void initTEM( RegMITTEM& xtem )
{
  ...
  // Initialize soil texture and other soil characteristics for
  //   the whole region

#ifdef STANDALONE_TEM
  xtem.setMITSoilCharacterRegion();
#endif
...
//      || (0 == xtem.istateflag && 0 == pdyr) )
  ...
  {   
    if( xtem.istateflag > 0 && 0 == pdyr ) { tstyr = -1; }
    else if( 0 == xtem.istateflag && pdyr < (xtem.totsptime+1) )
    {
      tstyr = 0;
    }
    else
