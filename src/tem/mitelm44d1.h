/* **************************************************************
*****************************************************************
MITELM44D1.H - Determines the interface among MITCLM, LCLUC and 
...
20150428 - DWK added include landcover4tem44d1.hpp
20150428 - DWK changed include from mitclm44c.h to mitclm44d1.h
20150428 - DWK changed include from mitelmntcohort44c.hpp to
           mitelmntcohort44d1.hpp
20150428 - DWK changed include from tigsmlcluc44c.h to
           tigsmlcluc44d1.h
20150428 - DWK changed include from mittem44c.h to mittem44d1.h
20150428 - DWK changed include from mitsoldat44c.h to
           mitsoldat44d1.h
20150428 - DWK changed include from mitsolyrdat44c.h to
           mitsolyrdat44d1.h
20150428 - DWK deleted include telvdat437.h
20150428 - DWK changed include tigsmtemdat44c.h to
           tigsmtemdat44d1.h
20150428 - DWK modified setGIStopography()
20150428 - DWK deleted elev from temgisqc()
...
//#include "landcover4tem44d1.hpp"

//Modules representing climate and TEM

#include "mitclm44d1.h"   // MITelmnt44 uses the MITclm44 class

// MITelmnt43 uses the MITElmntcohort44 
#include "mitelmntcohort44d1.hpp"  

#include "tigsmlcluc44d1.h" // MITelmnt44 uses the TEMlcluc44 class
#include "mittem44d1.h"     // MITelmnt44 uses the MITTEM44 class
...
#include "mitsoldat44d1.h"  

//MITelmnt44 uses the MITSoilLayerdata44 class
#include "mitsolyrdat44d1.h"  

#include "tigsmtemdat44d1.h"  //MITelmnt44 uses the Temdata44 class
...
//     void loadMITCLM( ifstream& ifile, MITdata43& clm );
     ...
     void setGIStopography( const double& ppctsand,
                            const double& ppctsilt,
                            const double& ppctclay,
                            const double& ppH,
                            double pthickness[CLMNLAYERS],
                                   double pporosity[CLMNLAYERS],
                                   double pKsat[CLMNLAYERS] );

//     void setGIStopography( const int& pigrd );
