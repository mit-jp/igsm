/* *************************************************************
TCLMDAT437.CPP - object to read and write the structure of the
...
int Clmdata43::get( ifstream& ifile )
{
...
int Clmdata43::getdel( FILE* ifile )
{
...
void Clmdata43::out( ofstream& ofile, 
                     const float& col, 
                     const float& row, 
...
void Clmdata43::outdel( ofstream& ofile, 
                        const float& col, 
                        const float& row, 
                        const string& varname,
                        const int& carea, 
...
void Clmdata43::pctout( ofstream& ofile, 
                        const float& col, 
                        const float& row, 
                        const string& varname,
                        const int& carea, 
...
void Clmdata43::poutdel( ofstream& ofile, 
                         const float& col, 
                         const float& row, 
                         const string& varname,
                         const int& carea, 
