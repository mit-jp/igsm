/* *************************************************************
****************************************************************
MITCLM437.CPP - physical characteristics of the atmosphere
...
void MITclm43::aggregFlux2D( const int& year,
                             const float& lat, 
...
void MITclm43::initDaySoilMoist( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initDayTair( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initDayTsoil( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initDRAINAGE ( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initEET ( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initHourSoilMoist( ofstream& rflog1 )
{
...
void MITclm43::initMITCflux( ofstream& rflog1 )
{
...
void MITclm43::initMITCH4flux( ofstream& rflog1 )
{
...
void MITclm43::initMITN2Oflux( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initMITSolarRad( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initPET( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initRainDuration( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initRainIntensity( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initSNOWPACK ( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initSoilH2O( ofstream& rflog1 )
{
...
#ifdef STANDALONE_TEM
void MITclm43::initSURFRUN ( ofstream& rflog1 )
{
...
void MITclm43::mkHourlyOzone( const double ozone3hrs[MAX3HRS] )
{
  int hr;
...
void MITclm43::mkMITaot40( const double ozone3hrs[MAX3HRS], 
		           const int& pdm )
{
...
void MITclm43::resetCFLUX( const int& outmon )
{
...
void MITclm43::resetCH4FLUX( const int& outmon )
{
...
void MITclm43::resetN2OFLUX( const int& outmon )
{
...
#ifdef STANDALONE_TEM
void MITclm43::setLatBandClm( ifstream& ifile, 
                              MITCLMdata43& clm )
{
...
void MITclm43::setLatBandClm( ifstream& ifile, MITdata43& clm )
{
...
#ifdef STANDALONE_TEM
void MITclm43::setLatBando3( ifstream& ifile, O3data43& clm )
{
...
#ifdef STANDALONE_TEM
void MITclm43::setLatBandSoil( ifstream& ifile,
                               const int& outmon, 
...
void MITclm43::setMITCH4Flags( ofstream& rflog1 )
{
...
void MITclm43::setMITN2OFlags( ofstream& rflog1 )
{
...
void MITclm43::setMITSolarRadFlags( ofstream& rflog1,
                                    const int& requil )
{
...
void MITclm43::timecheck( ofstream& rflog1 )
{
