/* *************************************************************
****************************************************************
TSOIL437.CPP - object describing general characteristics of 
                soil
...
Tsoil43::Tsoil43( void ) : ProcessXML43() 
{
...
void Tsoil43::getecd( ofstream& rflog1 )
{
...
void Tsoil43::getecd( const string& ecd )
{
  ifstream infile;
...
void Tsoil43::getrootz( ofstream& rflog1 )
{
...
void Tsoil43::getrootz( const string& ecd )
{
  ifstream infile;
  int dcmnt;
  int comtype;
...
void Tsoil43::lake( const double& tair,
                    const double& prec,
                    double& rain,
                    double& snowfall,
       		    const double& pet,
...
void Tsoil43::percol( const double& rain, const double& avlh2o )
{
...
void Tsoil43::resetMonthlyFluxes( void )
{
...
void Tsoil43::resetYrFluxes( void )
{
...
double Tsoil43::rrunoff( const double& rgrndh2o )
{
...
void Tsoil43::setKH2O( const double& vsm, 
                       const int& moistlim )
{
  double vfc;
...
double Tsoil43::snowmelt( const double& elev,
                          const double& tair,
...
double Tsoil43::srunoff( const double& elev,
                         const double& tair,
                         const double& prevtair,
...
void Tsoil43::updateHydrology( const double& elev,
                               const double& tair,
                               const double& prevtair,
                               const double& prev2tair,
                               const double& rain,
...
void Tsoil43::updateNLosses( const int& pdcmnt,
...
double Tsoil43::updateRootZ( const int& pdcmnt, 
                             const double& sh2o )
{
...
double Tsoil43::xeet( const double& rain, 
                      const double& pet,
                      const double& avlh2o,  
                      const int& pdm )
{
...
void Tsoil43::xtext( const int& pdcmnt,
