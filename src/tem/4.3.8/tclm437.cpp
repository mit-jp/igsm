/* *************************************************************
****************************************************************
TCLM437.CPP - describes climate module used by TEM
...
TEMclm43::TEMclm43() : Atmosphere43(), predstr( NUMATMS )
{
...
void TEMclm43::initCO2( ofstream& rflog1 )
{
  switch( tco2flag )
  {
...
void TEMclm43::initO3( ofstream& rflog1 )
{
...
void TEMclm43::initPrec( ofstream& rflog1 )
{
...
void TEMclm43::initSolarRad( ofstream& rflog1 )
{
...
void TEMclm43::initTair( ofstream& rflog1 )
{
...
************************************************************** */
/*
void TEMclm43::loadyrCO2( ifstream& rfco2,
                          const int& totsptime,
                          const int& rtime )
{
...
double TEMclm43::mkclds( const double& girr,
                         const double& nirr )
{
...
double TEMclm43::mkd40( const double& lon,
                        const double& lat,
...
void TEMclm43::setCldsFlags( ofstream& rflog1,
                             const int& requil )
{
...
void TEMclm43::setCO2Flags( ofstream& rflog1, const int& requil )
{
...
void TEMclm43::setO3Flags( ofstream& rflog1, const int& requil )
{
...
void TEMclm43::setPrecFlags( ofstream& rflog1, 
                             const int& requil )
{
...
void TEMclm43::setTairFlags( ofstream& rflog1,
                             const int& requil )
{
...
double TEMclm43::xgirr( const double& plat,
                        const int& pdm,
                        double& psumday )
{
...
double TEMclm43::xnirr( const double& clds, const double& girr )
{
...
double TEMclm43::xpar( const double& clds, const double& nirr )
{
