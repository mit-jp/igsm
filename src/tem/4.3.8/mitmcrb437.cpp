/* **************************************************************
*****************************************************************
MITMCRB437.CPP - object describing characteristics of soil 
...
#include "mitmcrb437.h"

/* **************************************************************
************************************************************** */

Tmicrobe43::Tmicrobe43() : ProcessXML43()
{
...
void Tmicrobe43::getvegecd( ofstream& rflog1 )
{
...
void Tmicrobe43::getvegecd( const string& ecd )
{
  ifstream infile;
  int dcmnt;
  int comtype;
...
double Tmicrobe43::nminxclm( const int& pdcmnt,
...
void Tmicrobe43::resetEcds( const int& pcmnt, 
...
void Tmicrobe43::resetMonthlyFluxes( void )
{
...
void Tmicrobe43::resetYrFluxes( void )
{
...
double Tmicrobe43::rhxclm( const double& soilorgc,
                           const double& dq10,
                           const double& moist )
{
...
void Tmicrobe43::setDQ10( const int& pdcmnt, 
                          const double& tair, 
...
double Tmicrobe43::setRHMOIST( const int& pdcmnt,
...
void Tmicrobe43::showecd( const int& pdcmnt )
{
...
void Tmicrobe43::updateDynamics( const int& pdcmnt,
                                 const double& pcfldcap,
                                 const double& soilorgc,
                                 const double& soilorgn,
                                 const double& soilh2o,
...
double Tmicrobe43::yrkd( const int& nfeed,
                         const double& yrltrc,
                         const double& yrltrn,
                         const int& pdcmnt )
{
