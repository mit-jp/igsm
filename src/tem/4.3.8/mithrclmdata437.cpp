/* *************************************************************
MITHRCLMDATA437.CPP - object to read and write hourly 
...
MITHrClmData43::MITHrClmData43( void ) { };


/* *************************************************************
************************************************************* */

void MITHrClmData43::get( ifstream& ifile )
{
  int dmlat;
  int ichrt;
  int hour24;
...
void MITHrClmData43::writeclm( ofstream& ofile, 
                               string varname, 
                               const int& dm, 
