/* *************************************************************
****************************************************************
MITTEM438.CPP - Terrestrial Ecosystem Model Version 4.3.7
****************************************************************
...
int MITTEM43::avlnflag = 0;
int MITTEM43::nfeed = 0;
int MITTEM43::rheqflag = 0;
int MITTEM43::moistlim = 0;
int MITTEM43::o3flag = 0;
int MITTEM43::initbase = 0;
int MITTEM43::baseline = 0;
int MITTEM43::intflag = 0;

int MITTEM43::maxnrun = 0;
int MITTEM43::equil = 0;
int MITTEM43::runsize = 0;
int MITTEM43::maxyears = 0;
int MITTEM43::strteq = 0;
int MITTEM43::endeq = 0;
int MITTEM43::startyr = 0;
int MITTEM43::endyr = 0;
int MITTEM43::diffyr = 0;
int MITTEM43::wrtyr = 0;

double MITTEM43::ctol = 1.0;
double MITTEM43::ntol = 0.02;
double MITTEM43::wtol = 0.01;

// Initialization of adaptive integrator variables

double MITTEM43::inittol = 0.01;
int MITTEM43::maxit = 20;
long MITTEM43::maxitmon = 2000;

double MITTEM43::a1 =   0.115740741;

double   MITTEM43::a3 =   0.548927875;
double  MITTEM43::a31 =   0.09375;
double  MITTEM43::a32 =   0.28125;

double   MITTEM43::a4 =   0.535331384;
double  MITTEM43::a41 =   0.879380974;
double  MITTEM43::a42 =  -3.277196177;
double  MITTEM43::a43 =   3.320892126;

double   MITTEM43::a5 =  -0.20;
double  MITTEM43::a51 =   2.032407407;
double  MITTEM43::a52 =  -8.0;
double  MITTEM43::a53 =   7.173489279;
double  MITTEM43::a54 =  -0.2058966866;

double   MITTEM43::b1 =   0.118518519;
double   MITTEM43::b3 =   0.518986355;
double   MITTEM43::b4 =   0.50613149;
double   MITTEM43::b5 =  -0.18;
double   MITTEM43::b6 =   0.036363636;
double  MITTEM43::b61 =  -0.296296296;
double  MITTEM43::b62 =   2.0;
double  MITTEM43::b63 =  -1.381676413;
double  MITTEM43::b64 =   0.45297271;
double  MITTEM43::b65 =  -0.275;


/* **************************************************************
************************************************************** */

MITTEM43::MITTEM43() : predstr( NUMTEM )
{
  tol = inittol;
  syint = 1;  
  totyr = -99;
...
int MITTEM43::adapt( const int& numeq, 
                     double pstate[], 
                     const double& ptol )
{
...
void MITTEM43::askODE( ofstream& rflog1 )
{
...
int MITTEM43::boundcon( double ptstate[],
                        double err[],
                        const double& ptol )
{
...
void MITTEM43::cropDynamics( double pstate[] )
{
...
void MITTEM43::delta( double pstate[],
                      double pdstate[] )
{
  if( 0 == ag.state )
  {
    natvegDynamics( pstate );
  }
  else
  {
    cropDynamics( pstate );
...
void MITTEM43::displayOptionalEflx( const seykey& s )
{
  switch( s )
  {
...
void MITTEM43::displayOptionalWflx( const swykey& s )
{
  switch( s )
  {
...
int MITTEM43::ecdqc( const int& dcmnt )
{
...
void MITTEM43::ECDsetODEstate( const int& pdcmnt,
...
void MITTEM43::getcropecd( const int& dv, const string& agecd )
{
  string agversion;
  string agsitename;
  string agdeveloper;
...
void MITTEM43::getenviron( const int& pdm )
{
...
double MITTEM43::getOptionalEflx( const int& optflx )
{
...
double MITTEM43::getOptionalWflx( const int& optflx )
{
...
void MITTEM43::getsitecd( const int& numcmnt, ofstream& rflog1 )
{
...
void MITTEM43::getsitecd( const int& dv, const string&  ecd )
{
  string kstring;
...
void MITTEM43::initrun( ofstream& rflog1, const int& equil )
{
...
void MITTEM43::massbal( double y[NUMEQ], 
...
int MITTEM43::monthlyTransient( const int& pdyr,
                                const int& pdm,
                                const double& ptol )
{
  endeq = 0;
...
void MITTEM43::natvegDynamics( double pstate[] )
{
...
void MITTEM43::pcdisplayDT( const double& tottime,
                             const double& deltat )
{
...
void MITTEM43::pcdisplayMonth( const int& dyr, const int& pdm )
{
  char limitC[2];
...
void MITTEM43::pcdisplayODEerr( const int& test, 
                                 double pstate[] )
{
  int errtest;
...
void MITTEM43::resetMonthlyELMNTFluxes( const int& pdm )
{
  ...
  soil.resetMonthlyTraceGasFluxes();
    
  ag.resetMonthlyFluxes( pdm );
...
void MITTEM43::resetODEflux( void )
{
  int i;
...
void MITTEM43::resetYrFluxes( void )
{
...
void MITTEM43::rkf( const int& numeq, 
                    double pstate[], 
                    double& pdt )
{
...
void MITTEM43::setELMNTecd( const int& pdcmnt,
                            const double& psiplusc )
{
...
void MITTEM43::setEquilC2N( const int& pdcmnt, 
                            const double& co2 )
{
...
void MITTEM43::setEquilEvap( const double& nirr,
                             const double& tair,
                             const int& pdm )
{
...
void MITTEM43::setPrevState( void )
{
...
void MITTEM43::step( const int& numeq, 
                   double pstate[], 
                   double pdstate[], 
                   double ptstate[],
	           double& pdt )
...
int MITTEM43::stepmonth( const int& pdyr,
                         const int& pdm,
                         int& intflag,
                         const double& ptol )
{
...
int MITTEM43::testEquilibrium( void )
{
...
void MITTEM43::updateYearSummary( void )
{
...
void MITTEM43::writesitecd( ofstream& fout, const int& dcmnt )
{
