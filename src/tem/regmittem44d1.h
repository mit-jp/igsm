/* *************************************************************
****************************************************************
REGMITTEM44D1.H - Extrapolation version of the Terrestrial 
...
20140828 - DWK changed include landcover4tem44c.hpp to
           landcover4tem44c1.hpp
...
20150429 - DWK changed incjude climate4tem44c.hpp to
           climate4tem44d1.hpp
20150429 - DWK changed include from landcover4tem44c1.hpp to
           landcover4tem44d1.hpp
20150429 - DWK changed include mitdata44c.h to mitdata44d1.h                                       20150429 - DWK changed include tigsmclmdat44c.h to 
           tigsmclmdat44d1.h
20150429 - DWK changed include mitclmdata44c.h to 
           mitclmdata44d1.h
20150429 - DWK changed include mitdaychrtdata44c.h to
           mitdaychrtdata44d1.h
20150429 - DWK changed include mitdayclmdata44c.h to
           mitdayclmdata44d1.h
20150429 - DWK changed include mithrclmdata44c.h to
           mithrclmdata44d1.h
20150429 - DWK changed include o3data44c.h to o3data44d1.h
20150429 - DWK changed include mitelm44c.h to mitelm44d1.h
20150429 - DWK added setMITSoilCharacterRegion()

****************************************************************
************************************************************* */

#ifndef REGMITTEM44D_H
#define REGMITTEM44D_H
...
#include "mitdata44d1.h" 
  ...
  #include "tigsmclmdat44d1.h"      // Clmdata43 class
#endif

#ifdef STANDALONE_TEM 
  // MITclm43 uses the MITCLMdata43 class
  #include "mitclmdata44d1.h" 
#endif

#ifdef STANDALONE_TEM 
  // MITclm43 uses the MITDayChrtData43 class
  #include "mitdaychrtdata44d1.h" 
#endif
  ...
  #include "mithrclmdata44d1.h" 
#endif

#ifdef STANDALONE_TEM 
  // MITclm43 uses the O3data class
  #include "o3data44d1.h"   
#endif
...
#include "mitelm44d1.h"       // MITelmnt Class
...
************************************************************* */
     ...
     #ifdef STANDALONE_TEM
       void setMITSoilCharacterRegion( void );
     #endif
