/* *************************************************************
****************************************************************
MITTEM44C.CPP - Terrestrial Ecosystem Model Version 4.4
****************************************************************
...
20110706 - DWK changed include from mittem44b.h to mittem44c.h
20110706 - DWK deleted land-use change algorithms from 
           stepmonth()
20150429 - DWK added include preproc.hpp                                                           20150429 - DWK changed include mittem44c.h to mittem44d1.h                                                                                     
****************************************************************
************************************************************** */
...
// *************************************************************
  ...
  if( pdm > 0 )
  {
    ag.setFORMPROD10C( ZERO );
    ag.setFORMPROD10N( ZERO );

    ag.setFORMPROD100C( ZERO );
    ag.setFORMPROD100N( ZERO );
  }
