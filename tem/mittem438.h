/* *************************************************************
****************************************************************
MITTEM438.H - Terrestrial Ecosystem Model Version 4.3.7
****************************************************************
...
#include "bioms423.hpp"   // TTEM50 uses Biomass class


// Objects describing the structure of the ecosystem

#include "mitatms437.h"    // TTEM43 uses MITatms43 class
#include "tveg438.h"    // TTEM43 uses Tveg43 class
#include "mitsoil437.h"   // TTEM43 uses MITsoil43 class
#include "mitmcrb437.h"  // TTEM43 uses Tmicrobe43 class

// Objects describing the effects of human activities on the 
//   ecosystem

#include "humnact438.h" // TTEM43 uses Humnact43 class
...
************************************************************** */
     ...
     void resetMonthlyELMNTFluxes( const int& pdm );
...
************************************************************** */
     ...
     void natvegDynamics( double pstate[] );
