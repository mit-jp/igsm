/* *************************************************************
METHANOGEN51.CPP - Describes methanogen dynamics in 
...
#include "methanogen51.h"

/* *************************************************************
************************************************************* */

Methanogen51::Methanogen51() : ProcessXML43()
{
...
double Methanogen51::EffectOM( const int& pcmnt,
                               const double& vegNPP )
{
...
double Methanogen51::EffectOMD( const int& pcmnt,
                                const double& depthz, 
                                const double& rootd )
{
...
double Methanogen51::EffectPH( const double& soilph )
{
...
double Methanogen51::EffectRX( const double& ehl )
{
...
double Methanogen51::EffectST( const int& pcmnt,
                               const double& soilt )
{
...
void Methanogen51::getecd( ofstream& rflog1 ) 
{
  string ecd;
...
void Methanogen51::getecd( const string& ecd )
{
...
double Methanogen51::produceCH4( const int& pcmnt, 
                                 const double& vegNPP,  
                                 const double& depthz, 
                                 const double& rootd,   
                                 const double& soilt, 
