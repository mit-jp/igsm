/* *************************************************************
TPROCESSMXL437.CPP - Functions to process XML files for TEM
...
void ProcessXML43::endXMLcommunityNode( ifstream& infile )
...
void ProcessXML43::endXMLtvegNode( ifstream& infile )
...
int ProcessXML43::getXMLcommunityNode( ifstream& infile,
...
double ProcessXML43::getXMLcmntArrayDouble( ifstream& infile,
                                            const string& rootnode,
...
int ProcessXML43::getXMLcmntArrayInt( ifstream& infile,
                                      const string& rootnode,
                                      const string& varnode,
                                      const int& index )
{
...
long ProcessXML43::getXMLcmntArrayLong( ifstream& infile,
                                        const string& rootnode,
                                        const string& varnode,
                                        const int& index )
{
...
double ProcessXML43::getXMLdouble( ifstream& infile,
                                   const string& rootnode,
                                   const string& varnode )
{
  string line;
...
int ProcessXML43::getXMLint( ifstream& infile,
                             const string& rootnode,
                             const string& varnode )
{
  string line;
...
long ProcessXML43::getXMLlong( ifstream& infile,
                               const string& rootnode,
                               const string& varnode )
{
  string line;
...
int ProcessXML43::getXMLrootNode( ifstream& infile,
                                  const string& rootnode )
...
int ProcessXML43::getXMLsiteCommunityNode( ifstream& infile,
                                           const string& rootnode,
                                           string& description )
...
int ProcessXML43::getXMLsiteRootNode( ifstream& infile,
                                      const string& rootnode,
                                      string& version,
                                      string& sitename,
                                      string& sitecol,
...
int ProcessXML43::getXMLtemvegNode( ifstream& infile,
                                    const string& rootnode )
{
  string line;
  string value;
...
double ProcessXML43::getXMLtvegArrayDouble( ifstream& infile,
                                            const string& rootnode,
                                            const string& varnode,
                                            const int& index )
...
int ProcessXML43::getXMLtvegArrayInt( ifstream& infile,
                                      const string& rootnode,
                                      const string& varnode,
                                      const int& index )
{
