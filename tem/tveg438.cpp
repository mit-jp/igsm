/* *************************************************************
****************************************************************
TVEG438.CPP - object describing characteristics of vegetation 
...
void Tveg43::boundTOPT( const int& pcmnt )
{
...
double Tveg43::deltaleaf( const int& pdcmnt,
                          const double& eet,
...
void Tveg43::getecd( ofstream& rflog1 )
{
...
void Tveg43::getecd( const string& ecd )
{
  int comtype;
  int dcmnt;
  ifstream infile;
...
void Tveg43::getleafecd( ofstream& rflog1 )
{
...
void Tveg43::getleafecd( const string& ecd )
{
  int comtype;
  int dcmnt;
  ifstream infile;
...
double Tveg43::gppxclm( const int& pdcmnt,
                        const double& co2,
                        const double& par,
                        const double& temp,
                        const double& gv,
...
double Tveg43::gppxio3( const double& fozone,
                        const double& eetpet )
{
  double findozone;
...
double Tveg43::gppxo3( const int& pdcmnt,
                       const double& gpp,
                       const double& d40,
                       const double& eetpet )
{
...
void Tveg43::leafinit( ofstream& rflog1 )
{
...
double Tveg43::nupxclm( const int& pdcmnt,
...
void Tveg43::resetEcds( const int& pcmnt,
...
void Tveg43::resetMonthlyFluxes( void )
{  
  leaf = ZERO;
  lai = ZERO;
  fpc = ZERO;
...
void Tveg43::resetNEWTOPT( const int& pcmnt, 
                           const double& tair, 
...
void Tveg43::resetYrFluxes( void )
{
...
double Tveg43::rmxclm( const int& pdcmnt,
                       const double& vegc,
                       const double& respq10 )
{
...
double Tveg43::setGV( const double& eet,
                      const double& pet,
                      const int& moistlim )
{
  double tstgv;
...
void Tveg43::setRESPQ10( const int& pdcmnt, const double& tair )
{
/* *************************************************************
...
void Tveg43::setTEMP( const int& pdcmnt, const double& tair )
{
...
void Tveg43::showecd( const int& pdcmnt )
{
...
void Tveg43::showleaf( const int& pdcmnt )
{
...
void Tveg43::updateC2N( const int& pdcmnt,
                        const double& yreet,
                        const double& yrpet,
...
void Tveg43::updateDynamics( const int& pdcmnt,
                             const double& co2,
                             const double& aot40,
                             const double& ninput,
                             const double& par,
