/* *************************************************************
METHANOTROPH51.CPP - Describes activity of methanotrophs
...
#include "methanotroph51.h"

/* *************************************************************
************************************************************* */

Methanotroph51::Methanotroph51() : ProcessXML43()
{
...
double Methanotroph51::consumeCH4( const int& pcmnt,
                                   const double& ch4con, 
                                   const double& oxyc, 
                                   const double& soilt,
                                   const double& soilm, 
...
double Methanotroph51::EffectCT( const int& icul )
{
...
double Methanotroph51::EffectMC( const int& pcmnt,
                                 const double& ch4con )
{
...
double Methanotroph51::EffectOXY( const int& pcmnt,
                                  const double& oxyc )
{
...
double Methanotroph51::EffectRX( const double& ehl )
{
...
double Methanotroph51::EffectSM( const int& pcmnt,
                                 const double& soilm )
{
...
double Methanotroph51::EffectST( const int& pcmnt,
                                 const double& soilt )
{
...
void Methanotroph51::getecd( ofstream& rflog1 )
{
...
void Methanotroph51::getecd( const string& ecd )
{
