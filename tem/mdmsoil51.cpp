/* *************************************************************
****************************************************************
MDMSOIL51.CPP - object describing general characteristics of 
                soil for the Methane Dynamics Model (MDM)
...
20060125 - DWK added public function double RedoxP() from
           methanepro.cpp 
0060422 - DWK renamed interpolateSM() to be interpolateLayers() 
...
MDMsoil51::MDMsoil51() : ProcessXML43()
{
...
double MDMsoil51::CH4ebullition( const double& ch4con )
{
...
double MDMsoil51::CH4plantTransport( const double& tveg, 
                                     const double& prootd,
                                     const double& pz, 
                                     const double& psoilt,
                                     const double& ch4con )
...
double MDMsoil51::dryCH4diffusion( const double& ddf, 
                                   const double& lowb )
...
double MDMsoil51::dryCH4uptake( const double& ddf, 
                                const double& lowb )
{
...
double MDMsoil51::fgrow( const double& soilt )
{
...
double MDMsoil51::froot( const double& rootd, const double& z )
{
...
void MDMsoil51::getecd( ofstream& rflog1 ) 
{
  string ecd;
...
void MDMsoil51::getecd( const string& ecd )
{
...
double MDMsoil51::interpolateLayers( const double layerVar[10], 
...
double MDMsoil51::RedoxP( const double& watertable, 
                          const double& depthz, 
                          const double& wfpsl,
                          const int& pcmnt, 
                          const double& lowb )
...
double MDMsoil51::setDiffusivityFactor( const double& sand, 
                                        const double& silt, 
                                        const double& clay, 
                                        int satyorn )
{
...
void MDMsoil51::setOxygenConc( const double& afp, 
                               const double& lowb )
...
void MDMsoil51::setUnsaturatedZoneMoisture( const double& ph2otable )
{
...
double MDMsoil51::wetCH4diffusion( const double& lowb, 
...
double MDMsoil51::wetCH4flux( const double& lowb, 
                              const double& watertable, 
                              const double& soilt )
{
